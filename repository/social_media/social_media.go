...
func (sr *SocmedRepository) CreateSocmed(ctx context.Context, newSocmed _entities.Social_media) (_entities.Social_media, int, error) {
...
func (sr *SocmedRepository) GetAllSocmed(ctx context.Context) ([]_entities.Social_media, error) {
...
func (sr *SocmedRepository) GetSocmed(ctx context.Context, idSocmed int) (_entities.Social_media, error) {
...
func (sr *SocmedRepository) UpdateSocmed(ctx context.Context, updateSocmed _entities.Social_media, idSocmed int) (_entities.Social_media, error) {
...
func (sr *SocmedRepository) DeleteSocmed(ctx context.Context, idSocmed int) error {
